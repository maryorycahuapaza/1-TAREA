...
public class HelloApplication extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        boton.setOnAction(evento ->{
            ...
            mensaje.setText("¡Bienvenido "+valor+"!");mensaje.setStyle("-fx-text-fill:black");});
        boton1.setOnAction(event -> {mensaje.setText(contenido);mensaje.setStyle("-fx-text-fill:red");});
